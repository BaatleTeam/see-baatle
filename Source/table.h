...
void initWindowsParametres(const ShipsInfo *ships, const Board *board, Indents Indents, WindowParametres*, WindowParametres*, WindowParametres*, WindowParametres*, WindowParametres*);
